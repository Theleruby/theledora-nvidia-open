...
# vlc
dnf5 install -y vlc vlc-plugin-ffmpeg vlc-plugin-fluidsynth vlc-plugin-kde vlc-plugin-visualization vlc-plugin-notify vlc-plugin-pipewire vlc-plugins-freeworld
